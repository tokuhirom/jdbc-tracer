...
public class IntegrationTest {
    ...
    public void psUrl() throws SQLException {
        try (Connection connection = DriverManager.
                getConnection("jdbc:tracer:ps=me.geso.me.geso.jdbctracer.IntegrationTest$PSListener:h2:mem:test")) {
    ...
    public void rsUrl() throws SQLException {
        try (Connection connection = DriverManager.
                getConnection("jdbc:tracer:rs=me.geso.me.geso.jdbctracer.IntegrationTest$RSListener:h2:mem:test")) {
            List<String> names = new ArrayList<>();
